...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"node_modules/minijanus/minijanus.js":[function(require,module,exports) {
/**
...
var _minijanus = require("minijanus");
...
var session = new _minijanus.JanusSession(ws.send.bind(ws));
var handle = new _minijanus.JanusPluginHandle(session);
var conn = new RTCPeerConnection({});
window.conn = conn;
ws.addEventListener("message", function (ev) {
  return session.receive(JSON.parse(ev.data));
});
ws.addEventListener("open", /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            _context.next = 5;
            return handle.attach("eater.staafmixer");
          ...
          case 5:
            conn.addEventListener("icecandidate", function (ev) {
              ...
              handle.sendTrickle(ev.candidate || null).catch(function (e) {
                return console.error("Error trickling ICE: ", e);
              });
            });
            conn.addEventListener("track", function (e) {
              document.querySelector("video").srcObject = e.streams[0];
            });
            conn.addEventListener("negotiationneeded", function (_) {
              console.log("negotiation needed"); // let offer = conn.createOffer();
              ...
              Promise.all([local, remote]).catch(function (e) {
                return console.error("Error negotiating offer: ", e);
              });
            });
            _context.next = 10;
          ...
          case 12:
            ...
            _context.next = 16;
            return conn.setRemoteDescription(res.jsep);
...
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","minijanus":"node_modules/minijanus/minijanus.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
